...
`define PIPELINE_DATAPATH_BLOCK_ADDR_WIDTH  19
`define PIPELINE_DATAPATH_REG_ADDR_WIDTH    4
...
`define PIPELINE_DATAPATH_BLOCK_ADDR  19'h00044
...
`define PIPELINE_DATAPATH_IMEM_INTERACT    4'h0
`define PIPELINE_DATAPATH_IMEM_WRITE       4'h1
`define PIPELINE_DATAPATH_IMEM_RW_ADDRESS  4'h2
`define PIPELINE_DATAPATH_IMEM_WDATA       4'h3
`define PIPELINE_DATAPATH_DMEM_INTERACT    4'h4
`define PIPELINE_DATAPATH_DMEM_WRITE       4'h5
`define PIPELINE_DATAPATH_DMEM_RW_ADDRESS  4'h6
`define PIPELINE_DATAPATH_DMEM_WDATA_HI    4'h7
`define PIPELINE_DATAPATH_DMEM_WDATA_LO    4'h8
`define PIPELINE_DATAPATH_IMEM_RDATA       4'h9
`define PIPELINE_DATAPATH_DMEM_RDATA_LO    4'ha
`define PIPELINE_DATAPATH_DMEM_RDATA_HI    4'hb
`define PIPELINE_DATAPATH_HWREG1           4'hc
