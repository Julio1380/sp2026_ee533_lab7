...
LAB67:    if (*((unsigned int *)t62) > 0)
        goto LAB68;

LAB69:    memcpy(t61, t106, 8);
...
LAB99:    if (*((unsigned int *)t210) > 0)
        goto LAB100;

LAB101:    if (*((unsigned int *)t174) > 0)
        goto LAB102;

LAB103:    memcpy(t173, t219, 8);

LAB104:    xsi_vlogtype_concat(t6, 64, 64, 4U, t173, 16, t116, 16, t61, 16, t7, 16);
    t230 = (t0 + 1932);
...
LAB32:    xsi_vlog_unsigned_bit_combine(t6, 64, t12, 64, t20, 64);
    goto LAB36;

LAB34:    memcpy(t6, t12, 16);
    goto LAB36;
...
LAB49:    xsi_vlog_unsigned_bit_combine(t7, 16, t25, 16, t53, 16);
    goto LAB53;

LAB51:    memcpy(t7, t25, 8);
    goto LAB53;
...
LAB66:    xsi_vlog_unsigned_bit_combine(t61, 16, t101, 16, t106, 16);
    goto LAB70;

LAB68:    memcpy(t61, t101, 8);
    goto LAB70;
...
LAB83:    xsi_vlog_unsigned_bit_combine(t116, 16, t157, 16, t162, 16);
    goto LAB87;

LAB85:    memcpy(t116, t157, 8);
    goto LAB87;

LAB90:    *((unsigned int *)t187) = 1;
    *((unsigned int *)t188) = 1;
    goto LAB91;

LAB92:    *((unsigned int *)t174) = 1;
    goto LAB95;
...
LAB100:    xsi_vlog_unsigned_bit_combine(t173, 16, t214, 16, t219, 16);
    goto LAB104;

LAB102:    memcpy(t173, t214, 8);
    goto LAB104;
...
LAB56:    t185 = (t0 + 3820);
    ...
    *((unsigned int *)t189) = (t196 & 4294967294U);
    t197 = *((unsigned int *)t189);
    *((unsigned int *)t189) = (t197 | t191);
    t198 = *((unsigned int *)t190);
    *((unsigned int *)t190) = (t198 & 4294967294U);
    t199 = *((unsigned int *)t190);
    *((unsigned int *)t190) = (t199 | t192);
...
LAB52:    xsi_vlog_unsigned_bit_combine(t3, 1, t170, 1, t184, 1);
    goto LAB56;
...
extern void work_m_00000000003232419809_3667589453_init()
{
	static char *pe[] = {(void *)N31_0,(void *)N32_1,(void *)A36_2,(void *)A46_3,(void *)C69_4,(void *)C71_5,(void *)C73_6,(void *)C75_7};
	xsi_register_didat("work_m_00000000003232419809_3667589453", "isim/_tmp/work/m_00000000003232419809_3667589453.didat");
